...
export declare class EventTimelineSet extends TypedEventEmitter<EmittedEvents, EventTimelineSetHandlerMap> {
     ...
     * the relationType.
     */
    getRelationsForEvent(eventId: string, relationType: RelationType | string, eventType: EventType | string): Relations | undefined;
    getAllRelationsEventForEvent(eventId: string): MatrixEvent[];
    /**
