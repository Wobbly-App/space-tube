  ...
  verify() {
    ...
    if (this.doVerification && !this.started) {
      ...
      new Promise((resolve, reject) => {
        var _this$baseApis$crypto;

        const crossSignId = (_this$baseApis$crypto = this.baseApis.crypto.deviceList.getStoredCrossSigningForUser(this.userId)) === null || _this$baseApis$crypto === void 0 ? void 0 : _this$baseApis$crypto.getId();
