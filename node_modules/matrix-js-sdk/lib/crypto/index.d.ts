...
export declare class Crypto extends TypedEventEmitter<CryptoEvent, CryptoEventHandlerMap> {
     ...
     */
    setDeviceVerification(userId: string, deviceId: string, verified?: boolean, blocked?: boolean, known?: boolean, keys?: Record<string, string>): Promise<DeviceInfo | CrossSigningInfo>;
